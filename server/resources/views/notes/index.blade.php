...
@section('content') 
    ...
    <form method="post" action="{{ url('/notice/main') }}" class="search_container">
        {{ csrf_field() }}
    ...
    <div class="mb-4">
        ...
        <a href="{{ url('/notice/mynote') }}" class="btn btn-primary">
            自分のノートを見る
        </a>
        <a href="{{ url('/notice/profile') }}" class="btn btn-primary">
            自分のプロフィール
        </a>
